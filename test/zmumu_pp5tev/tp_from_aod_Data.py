...
process.source.fileNames = [
      '/store/data/Run2017G/SingleMuon/AOD/17Nov2017-v1/910000/E4B056C8-3031-E811-9D14-001E67E6F490.root',
      ]
...
if TRIGGER == "SingleMu":
    ...
    process.triggerResultsFilter.triggerConditions = cms.vstring( 'DUMMY' )
else:
...
process.mergedMuons = cms.EDProducer("CaloMuonMerger",
    ...
    muonsCut     = cms.string("pt > 7 && track.isNonnull"),
    caloMuonsCut = cms.string("pt > 7"),
    tracksCut    = cms.string("pt > 7"),
)
...
process.tpTree = cms.EDAnalyzer("TagProbeFitTreeProducer",
    ...
    flags = cms.PSet(
       TrackQualityFlags,
       MuonIDFlags,
       LowPtDoubleTriggerFlags,
       LowPtSingleTriggerFlags,
       HighPtSingleTriggerFlags
    ),
